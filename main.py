...
class BlogPost(db.Model):
    ...
    # table name of User (i'm lost...)
    author_id = db.Column(db.Integer, db.ForeignKey("users.id"))
    # create ref to the User object, the "posts" refers to the posts
...
#     post_commented = db.Column(db.Integer(100), nullable=False)
#     user_who_commented = db.Column(db.Integer, db.ForeignKey("users.id"))
...
def register():
    ...
    if form.validate_on_submit():
        ...
        print(f"check_user is: {check_user}")
        if check_user:
            print("1")
